...
3.  **Configure Environment**:
    ...
    NEXT_PUBLIC_CHAIN_ID=42220 # Use 42220 for mainnet or 44787 for Alfajores
...
-   **Wallet modal does not open**: Verify `NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID` is not left as a placeholder value.
...
-   Use [docs/support-playbook.md](docs/support-playbook.md) when collecting issue details for debugging.
